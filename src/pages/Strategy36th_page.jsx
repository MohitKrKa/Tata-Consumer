      ...
      <div className='marginal text-lg'>
        ...
        <div className='md:flex flex-row justify-center gap-5'>
          <div className='md:w-[50%] my-2'>
            <div className='text-xl font-semibold text-[#06aeef] mb-1'>PHARMACY CHANNEL</div>
          ...
          <div className='md:w-[50%] my-2'>
            <div className='text-xl font-semibold text-[#06aeef] mb-1'>FOOD SERVICE CHANNEL</div>
        ...
        <div className='bg-gradient-to-t from-gray-50 to-transparent p-4'>
          <img src="/dos/Page95.webp" className='w-[80%] mx-auto' alt="" />
        </div>
      </div>
    </>
  )
