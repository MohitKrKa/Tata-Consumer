...
const Strategy17th_page = () => {
  return (
    <motion.div className='w-[90%] h-auto mx-[5%] px-3 font-bold mb-5' variants={parentVariants}
    initial="hidden"
    whileInView="visible"
    viewport={{ once: true, amount: 0.2 }}>
<motion.div className='flex md:flex-row flex-col justify-center md:gap-10 gap-5' variants={parentVariants}>
<motion.div className='md:w-1/3 flex flex-col  items-center md:border-r-2 md:p-5 gap-5' variants={textVariants}>
...
<motion.div className='md:w-1/3 flex flex-col items-center md:border-r-2 p-5' variants={textVariants}>
