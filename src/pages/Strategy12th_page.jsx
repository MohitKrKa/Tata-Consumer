...
const Strategy12th_page = () => {
  return (
    <div className='marginal text-lg'>
      ...
      <div className='mb-5'>Brand health indicators, including top-of-mind awareness and consideration, are at an all time high. A focused marketing
        approach has deepened consumer connect.</div>
      <div className='md:flex items-stretch gap-6 mb-3'>
        {/* Card 1 */}
        <div className='md:w-[33%] h-fit flex flex-col justify-start gap-4'>
          <div className='w-full md:h-[35vh] p-6 bg-gray-100'>
            <img src="/155.webp" alt="" className="w-full h-full object-contain" />
          </div>
          <p>
        ...
        <div className='md:w-[33%] flex h-fit flex-col justify-start gap-4'>
          <div className='w-full md:h-[35vh] p-6 bg-gray-100'>
            <img src="/158.webp" alt="" className="w-full h-full object-contain" />
          </div>
          <p>
        ...
        <div className='md:w-[33%] flex h-fit flex-col justify-start gap-4'>
          <div className='p-6 w-full md:h-[35vh] bg-gray-100'>
            <img src="/159.webp" alt="" className="w-full h-full object-contain" />
          </div>
          <p>
      ...
      <div className='md:flex  items-stretch gap-6 justify-items-center mb-3'>
        ...
        <div className='md:w-[33%] h-fit flex flex-col justify-start gap-4'>
          <div className='w-full md:h-[35vh] p-6 bg-gray-100'>
            <img src="/164.webp" alt="" className="w-full h-full object-contain" />
          </div>
          <p>
          Tata Salt Sendha+
