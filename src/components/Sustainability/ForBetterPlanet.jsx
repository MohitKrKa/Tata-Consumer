    ...
    <>
     ...
     <Planet2nd_page/> */}
        ...
        <div>
          ...
          <div className="!my-5 bg-gray-50 !p-4 marginal">
                <h1 className=" text-[#176ab4] text-2xl sm:text-3xl font-[500]">
                  VISION
                </h1>
                <p className="bg-gradient-to-r from-[#0db14e] to-[#10b0ef] bg-clip-text text-transparent font-[400] mt-3 text-xl sm:text-3xl">
